    ...
    sidebar = ft.Container(
        ...
        content=ft.Column([
            ...
            ft.Container(expand=True, content=ft.Column([
                ...
                ft.ListTile(leading=ft.Icon(ft.Icons.INVENTORY_2, color=ft.Colors.WHITE_70),
                    title=ft.Text("Productos", color=ft.Colors.WHITE),
                    on_click=lambda e: cambiar_vista("productos")),
                ft.ListTile(leading=ft.Icon(ft.Icons.SHOPPING_CART, color=ft.Colors.WHITE_70),
                    title=ft.Text("Venta", color=ft.Colors.WHITE),
                    on_click=lambda e: cambiar_vista("venta")),
                ft.ListTile(leading=ft.Icon(ft.Icons.WARNING_AMBER, color=ft.Colors.WHITE_70),
                    title=ft.Text("Pérdidas", color=ft.Colors.WHITE),
                    on_click=lambda e: cambiar_vista("perdidas")),
                ft.ListTile(leading=ft.Icon(ft.Icons.BAR_CHART, color=ft.Colors.WHITE_70),
